...
var patterns = [
 ...
 "Who are the faculties in the Data Science and Engineering department?",
  "Can you list the faculties in the Mechinical Engineering department?"
];

var data = {
  "intents": [
    {
      "patterns": ["bitm college located","Location of BITM College","Where is BITM College located?"],
    ...
    {
      "patterns": [ "When was BITM established and who founded the college?","Established BITM started college founded"],
      "responses": [
  ...
  "What can you tell me about Data Science and Engineering?",
    ...
    },
    {
      ...
      "patterns": [
        "HODs",
        "Head of Departments","Who are the faculties in the Artificial Intelligence and Engineering department?",
        "Who are the Heads of Departments?",
        "Can you provide a list of the Head of Departments?",
        "Can you list the faculties in the Artificial Intelligence and Engineering department?",
      ],
  ...
  "Who are the staff members in the Computer Science and Engineering department?",
    ...
    {
        "patterns":["aiml faculties","Who are the faculties in the Artificial Intelligence and Engineering department?",
  "Can you list the faculties in the Artificial Intelligence and Engineering department?",
  "aiml faculty","aiml teachers","aiml staff"],
      ...
      {
        "patterns":["EEE faculties","Who are the faculties in the Electrical and Electronics Engineering department?",
  "Can you list the faculties in the Electrical and Electronics Engineering department?",
  "EEE faculty","EEE teachers","EEE staff"],
      ...
      {
        "patterns":["ECE faculties","Who are the faculties in the Electronics and Communication Engineering department?",
  "Can you list the faculties in the Electronics and Communication Engineering department?","ECE faculty","ECE teachers","ECE staff"],
      ...
      {
        "patterns":["Civil faculties","Who are the faculties in the Civil Engineering department?",
  "Can you list the faculties in the Civil Engineering department?",
  "civil faculty","civil teachers","civil staff"],
      ...
      {
        "patterns":["data science faculties","Who are the faculties in the Data Science and Engineering department?",
  "Can you list the faculties in the Data Science and Engineering department?","data science faculty","data science teachers","data science staff"],
        "responses":["data will be updated soon!"]
      },
      {
        "patterns":["ME faculties","Can you list the faculties in the Mechinical Engineering department?","ME faculty","ME teachers","ME staff"],
